(function(){
    ...
    kintone.events.on('mobile.app.record.create.show', noEditApproval);
    kintone.events.on('mobile.app.record.edit.show', noEditApproval);
    ...
    kintone.events.on('mobile.app.record.edit.submit', cancelSave);
    ...
    kintone.events.on("mobile.app.record.detail.process.proceed", putAuthorizer);
